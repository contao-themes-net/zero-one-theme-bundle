...
## [1.9.1](https://github.com/contao-themes-net/zero-one-theme-bundle/tree/1.9.1) – 2022-03-02
...
- [feature] add login template with placeholders

## [1.5.0](https://github.com/contao-themes-net/zero-one-theme-bundle/tree/1.5.0) – 2021-03-09

- [feature] add content box ([docs](https://pdir.de/docs/de/contao/themes/zeroone/elements/contentbox/))
- [feature] add price table ([docs](https://pdir.de/docs/de/contao/themes/zeroone/elements/pricebox/))
...
- [fix] fix scss paths for colour schemes in _custom_variables.scss
- [feature] add templates and styling for member modules (login, registration, personal data, lost and change password)
- [feature] update sql files
...
- [fix] update sql file for contao 4.9
- [feature] add minimal sql file for contao 4.9
